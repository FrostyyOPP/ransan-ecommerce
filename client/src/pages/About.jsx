...
export default function About() {
  return (
    <>
      <section className="bg-ink text-bone px-6 py-24">
        <div className="max-w-6xl mx-auto">
          <div className="font-mono text-[11px] tracking-wider2 text-acid">01 / THE STORY</div>
          <h1 className="font-display uppercase leading-[0.9] text-6xl md:text-9xl mt-4">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 space-y-8 text-lg leading-8">
        <p>
      ...
      <section className="grid md:grid-cols-2 border-y border-ink">
        <div className="p-12 bg-acid">
          <div className="font-mono text-[11px] tracking-wider2">02 / HOW</div>
          <h2 className="font-display text-5xl uppercase mt-3">Heavyweight. Boxy. Built to last.</h2>
      ...
      <section className="px-6 py-20 text-center">
        <h2 className="font-display uppercase text-5xl md:text-7xl leading-[0.9]">Join The Gang.</h2>
